// src/pages/Counseling/CounselingSection4.jsx
import React from 'react';
import Button from '../../components/ui/Button';

const CounselingSection4 = () => {
    const achievements = [
        {
          name: "Aditya Agarwal",
              ...
              <div className="overflow-x-auto scroll-smooth px-2 sm:px-4 no-scrollbar">
                <div className="flex gap-[20px] w-max max-[360px]:gap-[12px]">
                  {achievements.map((student, index) => (
                    <div
                      key={index}
                      className="flex-shrink-0 flex flex-col w-[190px] sm:w-[240px] md:w-[252px] h-[360px] sm:h-[420px] max-[360px]:w-[150px] max-[360px]:h-[300px]"
                    >
...
export default CounselingSection4;
